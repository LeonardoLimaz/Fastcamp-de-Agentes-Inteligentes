...
observations = st.text_area(
    "Observations",
    placeholder="e.g., I want an all-inclusive hotel and at least one wine tasting activity.",
) # Permite ao usuário adicionar restrições e preferências para o planejamento
