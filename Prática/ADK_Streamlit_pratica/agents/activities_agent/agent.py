...
async def execute(request):
    ...
    prompt = ( # Criação de um prompt que será enviado para o agente
        ...
        "Suggest 2-3 activities, each with name, description, price estimate, and duration. "
        "If the observations mention specific activities, themes, restrictions, or must-have experiences, "
        "use them to guide the recommendations and reflect that in the descriptions. "
