...
async def execute(request):
    ...
    prompt = (
        ...
        f"Trip observations or constraints: {observations or 'None provided.'} "
        "Suggest 2-3 realistic flight options. For each option, include airline, departure time, return time, "
        "price, and mention if it's direct or has layovers. If the observations mention flight-related preferences "
        "or constraints, prioritize and explicitly account for them in the suggestions."
    )
