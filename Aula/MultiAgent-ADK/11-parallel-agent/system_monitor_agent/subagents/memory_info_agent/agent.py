...
memory_info_agent = LlmAgent(
    ...
    description="Gathers and analyzes memory information", # Descrição do propósito do agente
    tools=[get_memory_info], # Lista das ferramentas disponíveis
    output_key="memory_info", # Salva a resposta do agente
)
