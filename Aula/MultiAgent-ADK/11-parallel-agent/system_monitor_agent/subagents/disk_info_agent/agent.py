...
disk_info_agent = LlmAgent(
    ...
    description="Gathers and analyzes disk information", # Descrição do propósito do agente
    tools=[get_disk_info], # Lista das ferramentas disponíveis
    output_key="disk_info", # Salva a resposta do agente
)
