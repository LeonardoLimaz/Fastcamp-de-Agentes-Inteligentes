...
cpu_info_agent = LlmAgent(
    ...
    description="Gathers and analyzes CPU information", # Descrição do propósito do agente
    tools=[get_cpu_info], # Lista das ferramentas disponíveis
    output_key="cpu_info", # Salva a resposta do agente
)
