...
system_info_gatherer = ParallelAgent(
    ...
    sub_agents=[cpu_info_agent, memory_info_agent, disk_info_agent], # Lista dos subagentes em paralelos
)

# --- 2. Create Sequential Pipeline to gather info in parallel, then synthesize ---
root_agent = SequentialAgent(
    name="system_monitor_agent",
    sub_agents=[system_info_gatherer, system_report_synthesizer], # Lista dos subagentes sequenciais
)
