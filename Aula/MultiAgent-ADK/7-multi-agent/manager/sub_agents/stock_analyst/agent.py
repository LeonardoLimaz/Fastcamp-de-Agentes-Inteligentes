...
stock_analyst = Agent(
    name="stock_analyst", # Mesmo nome da pasta
    model="gemini-2.5-flash-lite", # Modelo usado no agente
    description="An agent that can look up stock prices and track them over time.", # Descrição para explicar o que esse agente pode fazer, serve principalmente para o root agente saber o que ele pode fazer
    instruction="""
