...
customer_service_agent = Agent(
    ...
    description="Customer service agent for AI Developer Accelerator community", # Descrição do que o agente faz
    instruction="""
    ...
    **Interaction History:**
    ...
    """, # Principais intruções de como o agente deve agir
    sub_agents=[policy_agent, sales_agent, course_support_agent, order_agent], # Dando acesso aos quatros subagentes que são descritos na instrução do agente
    tools=[],
)
