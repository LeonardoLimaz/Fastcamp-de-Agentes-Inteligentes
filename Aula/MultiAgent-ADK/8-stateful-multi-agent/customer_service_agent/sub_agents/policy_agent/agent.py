...
policy_agent = Agent(
    ...
    description="Policy agent for the AI Developer Accelerator community", # Descrição do que o agente faz
    instruction="""
    ...
    """, # Instruções de como o agente deve agir e o que ele deve fazer
    tools=[],
)
