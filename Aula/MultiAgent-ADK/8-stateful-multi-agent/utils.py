...
async def process_agent_response(event): # Processa a resposta do usuário
...
async def call_agent_async(runner, user_id, session_id, query): # Encaminha a requisição para o agente
    ...
    try:
        async for event in runner.run_async( # Passa todas as informações para o agente para ele fornecer uma resposta adequada 
