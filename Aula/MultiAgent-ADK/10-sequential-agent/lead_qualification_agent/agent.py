...
root_agent = SequentialAgent(
    ...
    sub_agents=[lead_validator_agent, lead_scorer_agent, action_recommender_agent], # Lista dos subagentes
    description="A pipeline that validates, scores, and recommends actions for sales leads", # Descrição do propósito do agente
)
