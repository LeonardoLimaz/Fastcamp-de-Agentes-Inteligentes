...
action_recommender_agent = LlmAgent(
    ...
    {validation_status}
    """, # Instrução de como o agente de agir 
    description="Recommends next actions based on lead qualification.", # Descrição do propósito do agente
    output_key="action_recommendation", # Salva o resultado do agente 
)
