...
refinement_loop = LoopAgent(
    ...
    max_iterations=10, # Coloca-se um máximo de interações que pode ser feitas no loop
    sub_agents=[
        post_reviewer, # Primeiro agente do loop, ou seja, o que inicia o loop
        post_refiner, # Segundo agente do loop
    ],
    description="Iteratively reviews and refines a LinkedIn post until quality requirements are met", # Descrição do propósito do agente
)
...
root_agent = SequentialAgent(
    ...
    description="Generates and refines a LinkedIn post through an iterative review process", # Descrição do propósito do agente
)
