...
initial_post_generator = LlmAgent(
    ...
    description="Generates the initial LinkedIn post to start the refinement process", # Descrição do propósito do agente
    output_key="current_post", # Salva a resposta do agente
)
